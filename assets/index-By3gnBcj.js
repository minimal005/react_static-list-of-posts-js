...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>B.jsxs("div",{className:"CommentInfo",children:[B.jsxs("div",{className:"CommentInfo__title",children:[B.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",B.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),B.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Lc=({comments:e})=>B.jsx("div",{className:"CommentList",children:e.map(t=>B.jsx(Pc,{comment:t},t.id))}),Tc=({user:e})=>B.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Mc=({post:e})=>B.jsxs("div",{className:"PostInfo",children:[B.jsxs("div",{className:"PostInfo__header",children:[B.jsx("h3",{className:"PostInfo__title",children:e.title}),B.jsxs("p",{children:[" Posted by ",B.jsx(Tc,{user:e.user})]})]}),B.jsx("p",{className:"PostInfo__body",children:e.body}),e.comments.length>0?B.jsx(Lc,{comments:e.comments}):B.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}),Rc=({posts:e})=>B.jsx("div",{className:"PostList",children:e.map(t=>B.jsx(Mc,{post:t},t.id))}),Dc=()=>{function e(i){return Nc.find(n=>i===n.id)}const t=Cc.map(i=>({...i,user:e(i.userId),comments:zc.filter(n=>n.postId===i.id)}));return B.jsxs("section",{className:"App",children:[B.jsx("h1",{className:"App__title",children:"Static list of posts"}),B.jsx(Rc,{posts:t})]})};em(document.getElementById("root")).render(B.jsx(Dc,{}));
