...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>U.jsxs("div",{className:"CommentInfo",children:[U.jsxs("h4",{className:"CommentInfo__name",children:[" ",e.name]}),U.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email}),U.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Lc=({comments:e})=>U.jsx("div",{className:"CommentList",children:e.map(t=>U.jsx(Pc,{comment:t},t.id))}),Tc=({user:e})=>U.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Mc=({user:e,post:t,comments:i})=>U.jsxs("div",{className:"PostInfo",children:[U.jsxs("div",{className:"PostInfo__header",children:[U.jsx("h3",{className:"PostInfo__title",children:t.title}),U.jsxs("p",{children:[" Posted by ",U.jsx(Tc,{user:e})]})]}),U.jsx("p",{className:"PostInfo__body",children:t.body}),U.jsx("hr",{}),i?U.jsx(Lc,{comments:i}):U.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}),Rc=({posts:e,users:t,comments:i})=>U.jsx("div",{className:"PostList",children:e.map(n=>{const a=t.find(o=>n.userId===o.id),u=i.filter(o=>n.id===o.postId);return U.jsx(Mc,{user:a,post:n,comments:u.length>0?u:null},n.id)})}),Dc=()=>U.jsxs("section",{className:"App",children:[U.jsx("h1",{className:"App__title",children:"Static list of posts"}),U.jsx(Rc,{posts:Cc,users:Nc,comments:zc})]});em(document.getElementById("root")).render(U.jsx(Dc,{}));
